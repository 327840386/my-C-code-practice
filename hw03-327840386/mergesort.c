...
// write documentation for this merge function according to the template below
...
// write documentation for the mergeSort function here according to the template below
...
void sortIntegers(int* array, unsigned int size) {
    ...
    // Create a temporary array to store intermediate results during merging
